...
for row in csv.reader(f):  #translating the csv into a list, where every ROW is a LIST
    i = i + 1
    filename = "admin.rc%d"%(i) # %d is a placeholder for a digit and will be replaced by whatever %(i) is 
