...
MYKEY = 'api_key=Du4SESqN4nkolWoKUdqEjXCMVCRXje6RXAAPGNMU' ## this is our api key
# let's add some more variables to represent the other "chunks" of the URL
DATE = input('Please enter a date int he YYY-MM-DD format, or hit ENTER for todays date: ')
